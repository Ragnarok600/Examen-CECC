...
{
    public partial class Maestro_Registro : Form
    {
        public Maestro_Registro()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string query = "INSERT INTO tb_Maestro (nombre, ap_paterno, ap_materno, matricula_empleado, fecha_ingreso, email, telefono) " +
